...
/* ./.libs/lt-curl.c - temporary wrapper executable for .libs/curl
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Users/CKlammer/dev/curl-7.55.0/lib/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Users/CKlammer/dev/curl-7.55.0/lib/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "curl"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# curl - temporary wrapper script for .libs/curl\n", f);
  ...
  fputs ("    echo \"curl:curl:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6-2", f);
  fputs ("\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"curl:curl:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"curl:curl:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Users/CKlammer/dev/curl-7.55.0/lib/.libs:/usr/local/lib:/u", f);
  fputs ("sr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Users/CKlammer/dev/curl-7.55.0/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
